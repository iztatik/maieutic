...
L(1)=Revolute('a', prm.a1,   'alpha',  pi/2, 'd', prm.d1);  %  Linkage 1
...
function [q1 , q2 , q3] = invPos(xc, yc, zc) 
   ...
   D = -((sqrt(xc^2 + yc^2)-prm.a1)^2 + (zc-prm.d1)^2 - prm.a2^2 - prm.d4^2) / (2*prm.a2*prm.d4);
   
   q3 = atan2(D, sqrt(1-D^2));
   %q2 = atan2(zc-prm.d1, sqrt(xc^2 + yc^2)) - atan2(prm.d4*cos(q3), prm.a2 - prm.d4*sin(q3));
   q2 = atan2(zc-prm.d1, sqrt(xc^2 + yc^2)-prm.a1) - atan2(prm.d4*cos(q3), prm.a2 - prm.d4*sin(q3));
   q1 = atan2(yc, xc);
end
